...
READ FIRST:
- docs/aura-system-v2/03-phase1-data-structures.md
...
READ FIRST:
- docs/aura-system-v2/04-phase2-transformer.md
- docs/aura-system-v2/02-reference-spell-data.md
...
READ FIRST:
- docs/aura-system-v2/05-phase3-handler-integration.md
- docs/wowlab/00-data-flow.md
...
READ FIRST:
- docs/aura-system-v2/06-phase4-periodic-ticks.md
- docs/wowlab/00-data-flow.md
...
READ FIRST:
- docs/aura-system-v2/07-phase5-simulation-setup.md
