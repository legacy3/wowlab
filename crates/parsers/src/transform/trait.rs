...
fn build_order_index_map(
    dbc: &DbcData,
    loadouts: &[crate::dbc::TraitTreeLoadoutRow],
) -> HashMap<i32, i32> {
...
fn get_talent_name(dbc: &DbcData, definition: &crate::dbc::TraitDefinitionRow) -> String {
...
fn get_talent_description(dbc: &DbcData, definition: &crate::dbc::TraitDefinitionRow) -> String {
...
fn get_icon_file_name(dbc: &DbcData, definition: &crate::dbc::TraitDefinitionRow) -> String {
