...
export const ItemDamageTwoHandCasterRowSchema = Schema.Struct({
...
export type ItemDamageTwoHandCasterRow = Schema.Schema.Type<
  typeof ItemDamageTwoHandCasterRowSchema
>;
