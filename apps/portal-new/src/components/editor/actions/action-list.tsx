    ...
    return (
      <Center h="full">
        <VStack gap="2">
          ...
          <Text color="fg.muted">Select a list from the sidebar</Text>
        </VStack>
      </Center>
    );
  }
        ...
        {selectedList.actions.length === 0 ? (
          <Center py="12" borderWidth="1" borderStyle="dashed" rounded="lg">
            <VStack gap="4">
              ...
              <VStack gap="1">
                <Text fontWeight="medium">No actions yet</Text>
                <Text
                  textStyle="sm"
                  color="fg.muted"
                  textAlign="center"
                  maxW="52"
                >
                  Add spells, items, or call other action lists to build your
                  rotation.
                </Text>
              </VStack>
