...
export function List({ className, ...props }: ComponentProps<typeof Tabs.List>) {
...
export function Indicator({ className, ...props }: ComponentProps<typeof Tabs.Indicator>) {
  return <Tabs.Indicator className={clsx(styles.indicator, className)} {...props} />;
}
