...
export function Popup({ className, ...props }: ComponentProps<typeof Menu.Popup>) {
  return <Menu.Popup className={clsx(styles.popup, className)} {...props} />;
}

export function Item({ className, ...props }: ComponentProps<typeof Menu.Item>) {
  return <Menu.Item className={clsx(styles.item, className)} {...props} />;
}

export function Separator({ className, ...props }: ComponentProps<typeof Menu.Separator>) {
