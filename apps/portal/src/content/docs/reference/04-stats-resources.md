...
CombatStats {
    ...
    versatility: f32,       // Damage/healing bonus
}
```
...
- [Damage System](/docs/reference/03-damage-system) - How stats affect damage
- [Auras & Procs](/docs/reference/05-auras-procs) - How buffs modify stats
