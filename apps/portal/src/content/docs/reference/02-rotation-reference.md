...
Action::Run { list, condition }         // Never returns
...
| `focus.percent`     | f64  | Percentage (0.0 - 1.0)         |
...
| `target.health_percent` | f64  | Health percentage (0.0 - 1.0) |
...
| Expression      | Type | Description                       |
| --------------- | ---- | --------------------------------- |
| `player.haste`  | f64  | Haste multiplier (1.0 = no haste) |
| `player.crit`   | f64  | Crit chance (0.0 - 1.0)           |
...
| Less than        | `<`    | `target.health_percent < 0.2` |
...
- [Writing Rotations](/docs/guides/00-writing-rotations) - Practical guide
- [JIT Compiler](/docs/engine/02-jit-compiler) - How rotations compile to native code
