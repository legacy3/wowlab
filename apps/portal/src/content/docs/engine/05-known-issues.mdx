...
2. **Integrate SchoolModifiers** - Connect to damage pipeline
3. **Add tuning validation** - Log warnings for unused entries
4. **Wire up spell expressions** - Cost, CastTime, Range should use SpellDef
