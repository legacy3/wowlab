...
This documentation uses academic-style citations to reference external sources. Inline citations appear as superscript links. For example, the <Cite id="websocket">WebSocket protocol</Cite> enables full-duplex communication between clients and servers.
