...
The service is as-is and as-available. We do not promise uptime, accuracy, fitness for a purpose, or error-free results. Check results before you rely on them.

## Accounts and access

Sign-in uses third-party OAuth providers like [Discord](https://discord.com) or [GitHub](https://github.com). We may suspend or block access for abuse, security issues, or legal reasons.
