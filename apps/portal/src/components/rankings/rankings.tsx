...
function DpsRankingsInner() {
  ...
  return (
    <Tabs defaultValue="spec" className="flex flex-col gap-6">
      <TabsList className="w-full max-w-xl justify-start overflow-x-auto">
        <TabsTrigger value="spec">Spec Rankings</TabsTrigger>
        <TabsTrigger value="items">Most Wanted Items</TabsTrigger>
        <TabsTrigger value="sims">Top Sims</TabsTrigger>
      </TabsList>
      ...
      <TabsContent value="sims" className="space-y-6">
        ...
        <Card>
          ...
          <CardFooter className="bg-muted/60 px-6 py-4 text-sm text-muted-foreground">
            ...
            pages. We surface a rotating sample of the highest scoring public
            runs per spec.
          </CardFooter>
        </Card>
      </TabsContent>
...
type DpsRankingsProps = {
  specFilter?: string;
};

export function DpsRankings(_props: DpsRankingsProps) {
  return (
