...
export const propertyFormatters: Record<SpellDataKey, PropertyFormatter> = {
  ...
  auraDescription: formatString,
  schoolMask: formatSchoolMask,
  castTime: formatCastTime,
  duration: formatDuration,
  maxDuration: formatDuration,
  implicitTarget: formatTargeting,
  attributes: formatAttributes,
  recoveryTime: formatCooldown,
  manaCost: formatManaCost,
  powerType: formatNumber,
  powerCost: formatNumber,
  powerCostPct: formatScaling,
  chargeRecoveryTime: formatRechargeTime,
  startRecoveryTime: formatGCD,
  speed: formatMissileSpeed,
  radiusMin: formatYards,
  radiusMax: formatYards,
  ...
  facingCasterFlags: formatNumber,
  ...
  rangeMax1: formatYards,
  rangeMin1: formatYards,
  rangeMax0: formatYards,
  rangeMin0: formatYards,
  ...
  spellClassMask3: formatNumber,
  spellClassMask4: formatNumber,
};
