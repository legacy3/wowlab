...
export const DBC_TABLES = {
  ...
  globalColor: { file: "GlobalColor.csv", schema: Dbc.GlobalColorRowSchema, tableName: "global_color" },
  globalCurve: { file: "GlobalCurve.csv", schema: Dbc.GlobalCurveRowSchema, tableName: "global_curve" },
  globalStrings: { file: "GlobalStrings.csv", schema: Dbc.GlobalStringsRowSchema, tableName: "global_strings" },
  ...
  keystoneAffix: { file: "KeystoneAffix.csv", schema: Dbc.KeystoneAffixRowSchema, tableName: "keystone_affix" },
  ...
  mapChallengeMode: { file: "MapChallengeMode.csv", schema: Dbc.MapChallengeModeRowSchema, tableName: "map_challenge_mode" },
  ...
  mythicPlusSeason: { file: "MythicPlusSeason.csv", schema: Dbc.MythicPlusSeasonRowSchema, tableName: "mythic_plus_season" },
  mythicPlusSeasonKeyFloor: { file: "MythicPlusSeasonKeyFloor.csv", schema: Dbc.MythicPlusSeasonKeyFloorRowSchema, tableName: "mythic_plus_season_key_floor" },
  mythicPlusSeasonRewardLevels: { file: "MythicPlusSeasonRewardLevels.csv", schema: Dbc.MythicPlusSeasonRewardLevelsRowSchema, tableName: "mythic_plus_season_reward_levels" },
  mythicPlusSeasonTrackedAffix: { file: "MythicPlusSeasonTrackedAffix.csv", schema: Dbc.MythicPlusSeasonTrackedAffixRowSchema, tableName: "mythic_plus_season_tracked_affix" },
  mythicPlusSeasonTrackedMap: { file: "MythicPlusSeasonTrackedMap.csv", schema: Dbc.MythicPlusSeasonTrackedMapRowSchema, tableName: "mythic_plus_season_tracked_map" },
  overrideSpellData: { file: "OverrideSpellData.csv", schema: Dbc.OverrideSpellDataRowSchema, tableName: "override_spell_data" },
  powerType: { file: "PowerType.csv", schema: Dbc.PowerTypeRowSchema, tableName: "power_type" },
  ...
  resistances: { file: "Resistances.csv", schema: Dbc.ResistancesRowSchema, tableName: "resistances" },
